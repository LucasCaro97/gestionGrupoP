package com.grupop.gestion.Configuracion;


import java.math.BigDecimal;

public class ConvertidorNumATexto {
    ...
    public static String cantidadConLetra(String s) {
        ...
        BigDecimal parteDecimal = new BigDecimal(s).remainder(BigDecimal.ONE);
        int parteDecimalInteger = parteDecimal.multiply(new BigDecimal(100)).intValue();
        ...
        return result.toString() + "con " + parteDecimalInteger + "/100" ;
    }
